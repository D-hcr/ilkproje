<template>
    ...
    <v-carousel  id="carouselExampleControls"  class="carousel slide"  data-bs-ride="carousel" >
  ...
  <button id="button1" class="carousel-control-prev" type="button" style="color:black" data-bs-target="#carouselExampleControls" data-bs-slide="prev">
