<template>
    <section class="bilgialanı">
        <span id="içA" class="içbilgialanı">
            <a id="tıkresim" href="#">
            ...
            <p id="mte">Modayı takip et!</p>
            <p id="matte">Moda aksesuar trendlerini takip et,</p>
            <p id="ufso">uygun fiyatlarla sahip ol.</p>
        </span>
        <span id="içB" class="içbilgialanı">
             <a id="tıkresim2" href="#">
