<template>
    <v-container class="slider3-alan" >
        <v-text-field class="cerceve">
            <p id="çskp">Çok Satan Kadın Parfümleri</p>
            <a class="keşfetrek" href="#">KEŞFET</a>
        </v-text-field>
        <v-carousel  id="carouselExampleControlsad"  class="carousel slide"  data-bs-ride="carousel" >
  <section class="carousel-inner" >
    <v-carousel-item id="ciactive" class="carousel-item active">
  ...
  <button id="buttonb" class="carousel-control-next" type="button" data-bs-target="#carouselExampleControlsad" data-bs-slide="next">
